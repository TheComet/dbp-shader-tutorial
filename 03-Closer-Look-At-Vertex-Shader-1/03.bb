...
[center]03 - A Closer Look At The Vertex Shader Part 1[/center][/b]
...
In tutorial 02 you wrote your very first shader from scratch, and have a basic understanding of how it works.
...
Now don't get scared, it's really quite trivial to understand. In order to convert a homogeneous coordinate back to a cartesian coordinate, all you need to do is divide its x, y, and z components with its w component:
...
Oh oh, we've set [b]w[/b] to 0.0. If you look back a bit on how to convert to cartesian, you'll notice that we're dividing x, y, and z by 0. Believe it or not, this is actually a valid coordinate. It defines a point located infinitely away, but we're not using infinite numbers. This is how the GPU handles proper projections. How cool is that?
...
[b]*[/b] Vertex shaders use homogeneous coordinates, which allows the GPU to define and handle points located in infinity.
